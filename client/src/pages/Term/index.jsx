      ...
      <div data-custom-class="body">
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            ...
            >
              <strong>Last updated July 16, 2022</strong>
            </span>
            <br />
          ...
          <div style={{ lineHeight: "1.5", textAlign: "left" }}>
            <span style={{ fontSize: "15px" }}>
              <a data-custom-class="link" href="#products">
                <span style={{ color: "rgb(89, 89, 89)" }}>5. PRODUCTS</span>
              </a>
            </span>
          </div>
          <div style={{ lineHeight: "1.5", textAlign: "left" }}>
          ...
          <div style={{ lineHeight: "1.5", textAlign: "left" }}>
            <span style={{ fontSize: "15px" }}>
              <a data-custom-class="link" href="#disclaimer">
                <span style={{ color: "rgb(89, 89, 89)" }}>23. DISCLAIMER</span>
              </a>
            </span>
          </div>
          <div style={{ lineHeight: "1.5", textAlign: "left" }}>
          ...
          <div style={{ lineHeight: "1.5", textAlign: "left" }}>
            <span style={{ fontSize: "15px" }}>
              <a data-custom-class="link" href="#userdata">
                <span style={{ color: "rgb(89, 89, 89)" }}>26. USER DATA</span>
              </a>
            </span>
          </div>
          <div style={{ lineHeight: "1.5", textAlign: "left" }}>
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            ...
            >
              ...
              and KibiAccessories ("<strong>Company</strong>", “
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          <div
            ...
            style={{ lineHeight: "1.5" }}
          >
            <a name="_nds4qylockxx" id="_nds4qylockxx" />
            <strong>
              <span
                style={{
                  lineHeight: "115%",
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            ...
            >
              ...
              colors and details of the products.&nbsp;All products are subject
              to availability, and we cannot guarantee that items will be in
              stock. We reserve the right to discontinue any products at any
              time for any reason. Prices for all products are subject to
              change.
            </span>
          </div>
        </div>
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            ...
            >
              ...
              order.&nbsp;We reserve the right to correct any errors or mistakes
        ...
        >
          ...
          <a name="_h284p8mrs3r7" id="_h284p8mrs3r7" />
          <div
            className="MsoNormal"
            data-custom-class="heading_1"
            id="prohibited"
            ...
            <div className="MsoNormal" style={{ lineHeight: 1 }}>
              ...
              >
                ...
                >
                  ...
                  of the Site and the Marketplace Offerings and through
      ...
      <div align="center" style={{ textAlign: "left" }}>
        ...
        >
          ...
          >
            ...
            AND THE MARKETPLACE OFFERINGS OR DELETE YOUR ACCOUNT AND&nbsp;ANY
        ...
        >
          ...
          >
            ...
            Vietnam. KibiAccessories and yourself irrevocably consent that the
            courts of{" "}
            <span
              style={{
                fontSize: "11pt",
        ...
        >
          <span style={{ fontSize: "15px" }}>
            ...
            arbitration shall be HCM, Vietnam. The language of the proceedings
            shall be VietNamese. The governing law of the contract shall be
            substantive law of Vietnam.
          </span>
        </div>
        <div className="MsoNormal" style={{ lineHeight: 1, textAlign: "left" }}>
          <span style={{ fontSize: "15px" }}>
        ...
        >
          <span style={{ color: "rgb(89, 89, 89)" }}>
            <strong>
              ...
              >
                <strong>Phone: 0348098023</strong>
              </span>
            </strong>
          </span>
        </div>
        ...
        >
          <strong>
            ...
            >
              <strong>kibiaccessories@gmail.com</strong>
            </span>
          </strong>
        </div>
      </div>
